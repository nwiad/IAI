...
model = TextCNN(vocab_size=len(key2index), embedding=vectors, embedding_dim=EMBEDDING_DIM, filter_sizes=FILTER_SIZES, 
                filter_num=FILTER_NUM, output_dim=OUTPUT_DIM, dropout=DROPOUT).to(device)
